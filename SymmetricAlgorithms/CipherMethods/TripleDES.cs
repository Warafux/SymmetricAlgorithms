...
{
    class TripleDES : iCipherMethod
    {
        private TripleDESCryptoServiceProvider rc2;
        private Encoding encoding;
        private string cipherName = "TripleDES";
        private string extensionEncrypt = ".TripleDES";
        public TripleDES()
        {
            this.rc2 = new TripleDESCryptoServiceProvider();
